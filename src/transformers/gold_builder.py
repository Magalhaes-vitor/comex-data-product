...
class GoldBuilder:
    ...
    def build(self):
        ...
        # Consolidação final: os fatos essenciais (APS e MDIC) precisam ter sido salvos com sucesso.
        # O Fato Agro é tratado à parte — sua ausência esperada (CONAB não publicada) não derruba o resultado geral do mês.
